...
class TableAbout extends Component {
  constructor(props) {
    super(props);
  ...
  ConfirmDelete(index) {
    ...
    axios.get('http://localhost:8000/api/about/delete/'+index)
    .then(res => {
  ...
  childHandler(id,data){
    axios.post('http://localhost:8000/api/about/update/'+id, data)
    .then(res => {
      // console.log('success');
    })
  }
    ...
    return (
        ...
        <MaterialTable style={{minWidth: 50}}
          ...
          columns={[
            ...
            { title: 'Content About', field: 'text' },
          ]}
          data={query =>
            new Promise((resolve, reject) => {
              let url = 'http://localhost:8000/api/about/'
