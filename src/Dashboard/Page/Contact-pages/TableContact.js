...
class TableContact extends Component {
  ...
  ConfirmDelete(index) {
    ...
    axios.get('https://powerful-headland-43561.herokuapp.com/api/contact/delete/'+index)
    .then(res => {
  ...
  childHandler(id,data){
    axios.post('https://powerful-headland-43561.herokuapp.com/api/contact/update/'+id, data)
    .then(res => {
      // console.log('success');
    })
  }
  ...
  render(){
    return (
        ...
        <MaterialTable style={{minWidth: 50}}
          icons={tableIcons}
          title="contact Management Data Preview"
          ...
          data={query =>
            new Promise((resolve, reject) => {
              let url = 'https://powerful-headland-43561.herokuapp.com/api/contact/'
