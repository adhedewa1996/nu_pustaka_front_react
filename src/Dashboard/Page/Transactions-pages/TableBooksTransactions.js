...
class TableBooksTransactions extends Component {
  constructor(props) {
    super(props);
  ...
  ConfirmDelete(index) {
    ...
    axios.get('https://powerful-headland-43561.herokuapp.com/api/transactions/delete/'+index)
    .then(res => {
        this.setState({
  ...
  childHandler(id,data){
    axios.post('https://powerful-headland-43561.herokuapp.com/api/transactions/update/'+id, data)
    .then(res => {
      console.log('success');
    })
  }
  ...
  render(){
    return (
        ...
        <MaterialTable style={{minWidth: 50}}
          icons={tableIcons}
          title="Table Books Transactions Preview"
          ...
          data={query =>
            new Promise((resolve, reject) => {
              let url = 'https://powerful-headland-43561.herokuapp.com/api/transactions/'
...
export default TableBooksTransactions;
