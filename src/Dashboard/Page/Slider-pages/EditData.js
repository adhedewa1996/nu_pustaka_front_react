...
export default class ModalComponent extends React.Component {
  ...
  toggle() {
    ...
    console.log(index);
    axios.get('https://powerful-headland-43561.herokuapp.com/api/slider/edit/'+index)
    .then(res => {
        this.setState({
    ...
    async uploadFile(file){
        ...
        var index=this.props.dataFromParent;
        return  await axios.post('https://powerful-headland-43561.herokuapp.com/api/slider/update/'+index, formData, {
            headers: {
