...
class TableSlider extends Component {
  ...
  ConfirmDelete(index) {
    ...
    axios.get('https://powerful-headland-43561.herokuapp.com/api/slider/delete/'+index)
    .then(res => {
        this.setState({
  ...
  render(){
    return (
        <MaterialTable style={{minWidth: 50}}
          icons={tableIcons}
          title="slider Management Data Preview"
              ...
              render: rowData => (
                <div>
                  <ButtonGroup size="small" variant="text" color="primary" aria-label="text primary button group">
                    {this.state.alert}
                    <Button variant="outlined" size="small" color="secondary" onClick={() => this.deleteSlider(rowData.id)}>
                      <DeleteOutline />
                    </Button>
            ...
            },
            {
              ...
              render: rowData => (
                <img
                  ...
                  src={'https://powerful-headland-43561.herokuapp.com/api/image/'+rowData.img}
                  alt={rowData.img}
                />
              ),
            },
          ...
          data={query =>
            new Promise((resolve, reject) => {
              let url = 'https://powerful-headland-43561.herokuapp.com/api/slider/'
